  ...
  function renderLayout() {
    ...
    checkoutContainer.innerHTML =
      ...
      (!isReservation || items.length > 0 ? (
        ...
        '      <div class="x-complement-section" id="x-upsell-container" style="margin-top:16px;padding-top:16px;border-top:1px solid #f0f0f0;width:100%;box-sizing:border-box;touch-action:auto;">' +
