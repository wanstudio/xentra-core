...
class DeliveryCalculatorService {
  /**
   * Calculates delivery fee and eligibility based on distance and branch settings.
   * 
   * @param {Object} params
   * @param {number} params.distance_meters - Actual road distance from OSRM/mapping
   * @param {number} [params.free_km=0] - Configured free distance in KM
   * @param {number} [params.price_per_km=0] - Configured rate per KM
   * @param {number} [params.max_radius_km=0] - Maximum allowed delivery radius in KM
...
module.exports = DeliveryCalculatorService;
