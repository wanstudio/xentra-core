...
test('P3-07 product-page add never creates an order or a fulfillment_branch_id', () => {
  ...
  assert.deepStrictEqual(keys, ['activeDestination', 'branchContext', 'brand', 'cart', 'customerSession', 'location', 'matchedBranch', 'myTable', 'notes', 'orderContext', 'orderType', 'promo', 'recipient']);
});
